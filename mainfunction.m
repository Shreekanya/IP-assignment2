%all the lines are written by me, except that of dft and psnr, link has been
%mentioned in the function of dft and psnr code
...
k_double= im2double(kernel(1:74,1:74));     %this size is good for kernel 1
...
[r1, c1] = size(ker);     
kerpadding=padarray(ker,[(363),(363)],0,'both');    %padding the image with (800-74)/2
[r, c]= size(kerpadding);
